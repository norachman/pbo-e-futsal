...
<body>
    ...
    <script>
        ...
        $(document).ready(function () {
            $.get("booking.php?riwayat=1", function (response) {
                $.each(response, function (key, value){
                    $("#bokku").append("<tr><td>"+ value.nama +"</td><td>"+ lapangan[value.lapangan_id-1] +"</td><td>"+ value.tanggal +"</td><td>"+ value.jam +"</td><td><img src='"+ value.img + "' style='width: 40px;height:40px;cursor:pointer;'></td><td>"+ value.statuss +"</td><td>"+ value.harga +"</td>"+
                                        "<td style='text-align: center ;'>"+
                                            "<a href='payment.php?id_booking="+ value.id_booking +"'><i class='bi bi-wallet2'></i></a>"+
                                        "</td></tr>");
